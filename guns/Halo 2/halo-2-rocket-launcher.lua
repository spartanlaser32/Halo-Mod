...
data:extend{
    ...
    results = {{type = "item", name = "halo-2-rocket-launcher", amount = 1}}
  },{
    type = "recipe",
    name = "halo-2-rocket-launcher-ammo",
    enabled = true,
    ...
    results = {{type = "item", name = "halo-2-rocket-launcher-ammo", amount = 1}}
  }
}