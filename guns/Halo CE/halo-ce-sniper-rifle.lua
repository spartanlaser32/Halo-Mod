...
data:extend{
    {
        type = "ammo-category",
        name = "halo-ce-sniper-rifle-ammo",
        subgroup = "ammo-category"
    },{
        type = "ammo",
        name = "halo-ce-sniper-rifle-ammo",
        icons = {{ icon = "__base__/graphics/icons/firearm-magazine.png"},{ icon = "__Halo-Mod__/graphics/icons/halo-ce-sniper-rifle.png"}},
        ammo_category = "halo-ce-sniper-rifle-ammo",
        ammo_type = {
    ...
    icon = "__Halo-Mod__/graphics/icons/halo-ce-sniper-rifle.png",
    icon_size = 64,
    subgroup = "gun",
    ...
    attack_parameters =
    {
      ...
      range = 200,
      sound = {"__Halo-Mod__/sounds/sniper_rifle_fire_ruger21.wav",
    ...
    results = {{type = "item", name = "halo-ce-sniper-rifle-ammo", amount = 1}}
  }
}