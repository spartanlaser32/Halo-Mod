...
data:extend{
    {
        type = "ammo-category",
        name = "halo-ce-pistol-ammo",
        subgroup = "ammo-category"
    },{
        type = "ammo",
        name = "halo-ce-pistol-ammo",
        icons = {{ icon = "__base__/graphics/icons/firearm-magazine.png"},{ icon = "__Halo-Mod__/graphics/icons/halo-ce-pistol.png"}},
        ammo_category = "halo-ce-pistol-ammo",
        ammo_type = {
    ...
    attack_parameters =
    {
      ...
      range = 50,
      sound = "__Halo-Mod__/sounds/pistol_fire_handgun2.wav",
      damage_modifier = 5
    },
    stack_size = 5
  },{
    ...
    results = {{type = "item", name = "halo-ce-pistol-ammo", amount = 1}}
  }
}
